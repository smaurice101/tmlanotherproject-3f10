[tmlanotherproject-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tmlanotherproject-3f10] container is NOT running**.

.. tip::
   You must have your [tmlanotherproject-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   maadsdocker/tmlanotherproject-3f10-amd64 (https://hub.docker.com/r/maadsdocker/tmlanotherproject-3f10-amd64)
...
.. code-block::
   ...
   docker run -d -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=tmlanotherproject-3f10 \
          --env SOLUTIONDAG=solution_preprocessing_dag-tmlanotherproject-3f10 \
          ...
          maadsdocker/tmlanotherproject-3f10-amd64
...
[tmlanotherproject-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tmlanotherproject-3f10
...
.. important::
   https://tmlanotherproject-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-tmlanotherproject-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44909, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42165, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37177, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46151, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33493, HPDEHOST=127.0.1.1, HPDEPORT=35487, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44471

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5298-tmlanotherproject-3f10,solution_preprocessing_dag-tmlanotherproject-3f10, python-preprocess-4885-tmlanotherproject-3f10,solution_preprocessing_dag-tmlanotherproject-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
