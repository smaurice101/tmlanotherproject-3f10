Scaling [tmlanotherproject-3f10] With Kubernetes
===========================
...
Based on your TML solution [tmlanotherproject-3f10] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tmlanotherproject-3f10.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tmlanotherproject-3f10.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstmlanotherproject-3f10.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tmlanotherproject-3f10.yml

tmlanotherproject-3f10.yml
------------------------

.. important::
   Copy and Paste this YAML file: tmlanotherproject-3f10.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# tmlanotherproject-3f10.yml
     ...
     kind: Deployment
     metadata:
       name: tmlanotherproject-3f10
     spec:
       selector:
         matchLabels:
           app: tmlanotherproject-3f10
       ...
       template:
         ...
         spec:
           containers:
           - name: tmlanotherproject-3f10
             image: maadsdocker/tmlanotherproject-3f10-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: SOLUTIONNAME
               value: 'tmlanotherproject-3f10'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-tmlanotherproject-3f10'
             - name: GITUSERNAME
               value: 'smaurice101'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: tmlanotherproject-3f10-visualization-service
       labels:
         app: tmlanotherproject-3f10-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/tmlanotherproject-3f10 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tmlanotherproject-3f10.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-tmlanotherproject-3f10.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tmlanotherproject-3f10.yml
